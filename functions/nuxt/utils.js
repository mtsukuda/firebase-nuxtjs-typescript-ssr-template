...
export async function setContext(app, context) {
  ...
  if (!app.context) {
    app.context = {
      ...
      error: context.error,
      base: '/',
      env: {"baseUrl":"TODO_YOUR_BASE_URL","contactFormUrl":"TODO_YOUR_CONTACT_FORM_URL","policyUrl":"TODO_YOUR_PRIVACY_POLICY_URL","tosUrl":"TODO_YOUR_TERMS_OF_SERVICE_URL","twitterUrl":"TODO_YOUR_TWITTER_URL","firebaseConfig":"TODO_YOUR_FIREBASE_CONFIG","GA_ID":"TODO_YOUR_GOOGLE_ANALYTICS_ID"}
    }
    // Only set once
    if (context.req) {
